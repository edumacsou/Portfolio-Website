...
export const projectsData = [
    ...
    new projectData('Enigma Machine', 'https://i.imgur.com/yxZpmSE.png',"A digital version of an electromechanical dispositive, the concepts of object-oriented turns possible to transcript this machine into a code. It was made with the purpose of learning about cipher and developing programing skills.",'https://github.com/edumacsou/Enigma-Machine'),
    new projectData('Fractal Tree', 'https://i.imgur.com/OqMi59f.png','A fractal is a figure with a repetitive pattern: a small part of it is similar to the entire figure, what is called self-similar. This project is a python visual application that uses recursion to construct a colored fractal tree.','https://github.com/edumacsou/Fractal-Tree'),
    new projectData('Numerical Analysis', 'https://i.imgur.com/nLAHaDb.jpg','A simple snake game created with the Pygame library, and original sprites.','https://github.com/edumacsou/Numerical-Analysis'),
